<template>
    <div :class="['side-menu', menuActive ? 'active' : '']">
        <i @click="menuActive=!menuActive" class="menu-toggler lnr lnr-menu"></i>

        <div class="brand">
        
        </div>
        <div class="profile" v-blaze="'profile'"></div>
    </div>
</template>
<script>
    export default {
...
@import '~imports/client/ui/styl/mixins.styl'
