...
import InputField from '/imports/client/ui/components/form/InputField.vue'
import DateRange from '/imports/client/ui/components/form/DateRange.vue'
export default {
    data() {
        return {
            userOptions,
...
<style lang="stylus">
@import '~imports/client/ui/styl/variables'
